        ...
        <div className="max-w-5xl my-0 px-[10px] py-[50px] rounded-3xl bg-accent mx-[50px]">
          ...
          <div className="flex flex-col md:flex-row items-stretch gap-8 md:gap-12">
            ...
            <div className="flex-1 shadow-2xl rounded-3xl bg-primary px-8 py-10 text-center md:text-left">
              <h2 className="mb-6 font-display text-3xl font-bold text-neutral-50 text-center sm:text-3xl">Hi, I'm <span className="text-primary-foreground">Jhez!</span><br />Your Automation Sidekick Virtual Assistant!</h2>
